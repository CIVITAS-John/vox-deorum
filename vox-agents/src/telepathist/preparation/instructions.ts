...
1. "situation": A detailed paragraph covering the world state: military situation, economic state, diplomatic changes, research progress, and notable events.
...
3. "decisions": A detailed paragraph covering the player's decisions and reasoning: what options were available, what was chosen, and why.
...
1. "situation": A narrative paragraph of the phase's world state arc: how the military, economic, diplomatic, and research landscape evolved across these turns.
