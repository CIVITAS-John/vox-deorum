...
INSERT OR REPLACE INTO Language_en_US (Tag, Text)
VALUES ('TXT_KEY_SPECIFIC_DIPLO_STRING_1_SELF', 'Our leader has expressed a public opinion of this leader (%d).');

INSERT OR REPLACE INTO Language_en_US (Tag, Text)
VALUES ('TXT_KEY_SPECIFIC_DIPLO_STRING_2', 'Their leader has formed a private opinion of you (%d).');

INSERT OR REPLACE INTO Language_en_US (Tag, Text)
VALUES ('TXT_KEY_SPECIFIC_DIPLO_STRING_2_SELF', 'Our leader has formed a private opinion of this leader (%d).');
